...
//        case securityRegister(ASAuthorizationSecurityKeyPublicKeyCredentialRegistration) // unavailable in visionOS as of Jan '24
        case login(ASAuthorizationPlatformPublicKeyCredentialAssertion)
//        case securityLogin(ASAuthorizationSecurityKeyPublicKeyCredentialAssertion) // unavailable in visionOS as of Jan '24
        case canceled
        case error
    }
